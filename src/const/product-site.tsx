...
Минималистичный блок иконок на веб-сайте выполняет роль прямого навигационного моста: клик по соответствующему логотипу мгновенно перенаправляет пользователя в официальные магазины приложений (Google Play, App Store) или открывает инструкцию по быстрой установке клиента на телевизор с помощью QR-кода. Такой подход снижает порог входа, укрепляет доверие аудитории к технологической зрелости Mavji Somon и превращает сервис в универсальную медиасреду, готовую к работе на любом экране.`,
          ...
          },
          {
            ...
            shortInfo: "Главные премьеры и категории",
            fullInfo:
          ...
          {
            slug: "web-mult-page",
            title: "Раздел: Мультфильмы",
            imageSrc: "/images/projects/mavjisomon/web-mult-page.png",
            BannerSrc: "/images/projects/mavjisomon/web-mult-page.png",
            shortInfo: "Детский и семейный контент",
            fullInfo:
              "Раздел «Мультфильмы» — это безопасное и яркое пространство для детского и семейного просмотра. Центральный слайдер (Hero Banner) здесь часто используется для продвижения красочных анимационных новинок (например, «ТОЛЬКО ВО СНЕ»), сразу настраивая юных зрителей и их родителей на нужный лад.\n\nВ нижней части расположена навигация по поджанрам (Семейный, Детский, Сказка и т.д.) и лента с популярными тайтлами («Душа», «Кролик Питер 2», «Зверополис»). Дизайн остается строгим и темным, как и весь сайт, но благодаря обилию красочных постеров сам раздел воспринимается живо и позитивно. Продуманная категоризация позволяет родителям быстро найти подходящий мультфильм для ребенка любого возраста.",
          },
          {
            slug: "web-tajik-page",
            title: "Раздел: Таджикские фильмы",
            imageSrc: "/images/projects/mavjisomon/web-tajik-page.png",
            BannerSrc: "/images/projects/mavjisomon/web-tajik-page.png",
            shortInfo: "Национальный кинематограф",
            fullInfo:
              "Раздел «Таджикские фильмы» является уникальной особенностью и гордостью платформы Mavji Somon. Он посвящен сохранению и популяризации национального кинематографа. В главном баннере раздела бережно промоутируется бессмертная классика, такая как легендарный фильм 1957 года «Я ВСТРЕТИЛ ДЕВУШКУ».\n\nНиже представлена богатая коллекция таджикского кино, от исторических эпосов («Рустам», «Оинаи бешиша») до современных драм и криминальных историй («Кандидат», «Преступник и адвокаты»). Каталог снабжен подробными фильтрами по жанрам. Этот раздел не только предлагает развлекательный контент, но и несет важную культурную миссию, предоставляя пользователям удобный цифровой доступ к золотому фонду отечественного кино наряду с современными релизами.",
          },
          {
            slug: "web-radio",
