        ...
        items: [
          {
            ...
            imageSrc: "/images/projects/mavjisomon/web-hero1.png",
          ...
          },
          {
            ...
            imageSrc: "/images/projects/mavjisomon/web-platform.png",
            BannerSrc: "/images/projects/mavjisomon/web-platform.png",
            shortInfo: "Интеграция с ОС",
            fullInfo:
              "Проект Mavji Somon не ограничивается только веб-версией, и этот компонент интерфейса наглядно демонстрирует полную кроссплатформенность сервиса. На сайте представлен лаконичный блок с узнаваемыми монохромными иконками трех главных экосистем: Android, iOS (Apple) и Smart TV.\n\nНаличие этого блока информирует пользователей о том, что для каждой из этих операционных систем разработано специализированное нативное приложение. Веб-сайт служит не только как самостоятельный портал для просмотра видео, но и как центральная точка входа, откуда пользователи могут узнать о доступности сервиса на своих любимых устройствах и подготовиться к переходу на мобильный или ТВ-формат просмотра.",
          },
          {
            slug: "web-freedom",
            title: "Свобода выбора",
            imageSrc: "/images/projects/mavjisomon/web-freedom2.png",
            BannerSrc: "/images/projects/mavjisomon/web-freedom.png",
          ...
          },
          {
            ...
            imageSrc: "/images/projects/mavjisomon/web-footer2.png",
            BannerSrc: "/images/projects/mavjisomon/web-footer.png",
          ...
          {
            slug: "web-recommendations",
            title: "Рекомендуем посмотреть",
            imageSrc: "/images/projects/mavjisomon/web-recommendations.png",
            BannerSrc: "/images/projects/mavjisomon/web-recommendations2.png",
