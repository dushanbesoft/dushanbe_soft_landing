        ...
        items: [
          {
            ...
            imageSrc: "/images/projects/somontv/header-page.png",
            BannerSrc: "/images/projects/somontv/header-page.png",
            shortInfo: {
              ru: "Обзор раздела «Шапка сайта»",
              en: "Overview of the «Header» section",
              tj: "Баррасии бахши «Сарлавҳаи сомона»",
            ...
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Шапка сайта» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «Header» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Сарлавҳаи сомона»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
          {
            slug: "all-page",
            ...
            imageSrc: "/images/projects/somontv/all-page.png",
            BannerSrc: "/images/projects/somontv/all-page.png",
            shortInfo: {
              ru: "Обзор раздела «Все видео»",
              en: "Overview of the «All Videos» section",
              tj: "Баррасии бахши «Ҳамаи видеоҳо»",
            },
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Все видео» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «All Videos» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Ҳамаи видеоҳо»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
          {
            slug: "films-page",
            ...
            imageSrc: "/images/projects/somontv/films-page.png",
            BannerSrc: "/images/projects/somontv/films-page.png",
            shortInfo: {
              ru: "Обзор раздела «Фильмы»",
              en: "Overview of the «Films» section",
              tj: "Баррасии бахши «Филмҳо»",
            },
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Фильмы» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «Films» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Филмҳо»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
          {
            slug: "serials-page",
            ...
            imageSrc: "/images/projects/somontv/serials-page.png",
            BannerSrc: "/images/projects/somontv/serials-page.png",
            shortInfo: {
              ru: "Обзор раздела «Сериалы»",
              en: "Overview of the «Series» section",
              tj: "Баррасии бахши «Силсилафилмҳо»",
            },
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Сериалы» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «Series» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Силсилафилмҳо»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
          {
            slug: "cartoon-series-page",
            title: {
              ru: "Мультсериалы",
              en: "Animated Series",
              tj: "Силсилафилмҳои тасвирӣ",
            },
            imageSrc: "/images/projects/somontv/cartoon-series-page.png",
            BannerSrc: "/images/projects/somontv/cartoon-series-page.png",
            shortInfo: {
              ru: "Обзор раздела «Мультсериалы»",
              en: "Overview of the «Animated Series» section",
              tj: "Баррасии бахши «Силсилафилмҳои тасвирӣ»",
            },
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Мультсериалы» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «Animated Series» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Силсилафилмҳои тасвирӣ»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
          {
            slug: "cartoons-page",
            ...
            imageSrc: "/images/projects/somontv/cartoons-page.png",
            BannerSrc: "/images/projects/somontv/cartoons-page.png",
            shortInfo: {
              ru: "Обзор раздела «Мультфильмы»",
              en: "Overview of the «Cartoons» section",
              tj: "Баррасии бахши «Филмҳои тасвирӣ»",
            },
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Мультфильмы» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «Cartoons» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Филмҳои тасвирӣ»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
          {
            slug: "radio-page",
            ...
            imageSrc: "/images/projects/somontv/radio-page.png",
            BannerSrc: "/images/projects/somontv/radio-page.png",
            shortInfo: {
              ru: "Обзор раздела «Радио»",
              en: "Overview of the «Radio» section",
              tj: "Баррасии бахши «Радио»",
            },
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Радио» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «Radio» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Радио»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
          {
            slug: "musics-page",
            ...
            imageSrc: "/images/projects/somontv/musics-page.png",
            BannerSrc: "/images/projects/somontv/musics-page.png",
            shortInfo: {
              ru: "Обзор раздела «Музыка»",
              en: "Overview of the «Music» section",
              tj: "Баррасии бахши «Мусиқӣ»",
            },
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Музыка» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «Music» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Мусиқӣ»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
          {
            slug: "new-interesting-rating-page",
            title: {
              ru: "Рекомендации и рейтинги",
            ...
            shortInfo: {
              ...
              tj: "Баррасии бахши «Тавсияҳо ва рейтингҳо»",
            },
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Рекомендации и рейтинги» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «Recommendations and Ratings» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Тавсияҳо ва рейтингҳо»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
          {
            slug: "login-page",
            ...
            imageSrc: "/images/projects/somontv/login-page.png",
            BannerSrc: "/images/projects/somontv/login-page.png",
            shortInfo: {
              ru: "Обзор раздела «Авторизация»",
              en: "Overview of the «Login» section",
              tj: "Баррасии бахши «Воридшавӣ»",
            },
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Авторизация» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «Login» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Воридшавӣ»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
          {
            ...
            imageSrc: "/images/projects/somontv/registration-page.png",
            BannerSrc: "/images/projects/somontv/registration-page.png",
            shortInfo: {
              ru: "Обзор раздела «Регистрация»",
              en: "Overview of the «Registration» section",
              tj: "Баррасии бахши «Бақайдгирӣ»",
            },
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Регистрация» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «Registration» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Бақайдгирӣ»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
          {
            slug: "profile-page",
            ...
            imageSrc: "/images/projects/somontv/profile-page.png",
            BannerSrc: "/images/projects/somontv/profile-page.png",
            shortInfo: {
              ru: "Обзор раздела «Профиль пользователя»",
              en: "Overview of the «User Profile» section",
              tj: "Баррасии бахши «Профили корбар»",
            },
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Профиль пользователя» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «User Profile» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Профили корбар»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
          {
            slug: "footer-page",
            ...
            imageSrc: "/images/projects/somontv/footer-page.png",
            BannerSrc: "/images/projects/somontv/footer-page.png",
            shortInfo: {
              ru: "Обзор раздела «Подвал сайта»",
              en: "Overview of the «Footer» section",
              tj: "Баррасии бахши «Поёни сомона»",
            ...
            fullInfo: {
              ru: "Этот раздел демонстрирует интерфейс и возможности страницы «Подвал сайта» в онлайн-кинотеатре Somon TV. Дизайн выполнен в темной теме, ориентирован на удобный поиск и просмотр контента с учетом современных стандартов пользовательского опыта (UX) и интерфейса (UI).",
              en: "This section showcases the interface and features of the «Footer» page in the Somon TV online cinema. The design uses a dark theme and focuses on easy content discovery and viewing, built according to modern user experience (UX) and interface (UI) standards.",
              tj: "Ин бахш интерфейс ва имкониятҳои саҳифаи «Поёни сомона»-ро дар кинотеатри онлайни Somon TV намоиш медиҳад. Тарроҳӣ дар мавзӯи торик иҷро шуда, ба ҷустуҷӯ ва тамошои қулайи мундариҷа бо назардошти стандартҳои муосири таҷрибаи корбар (UX) ва интерфейс (UI) нигаронида шудааст.",
            },
          },
        ],
      },
        ...
        items: [
          {
            ...
            imageSrc: "/images/projects/sandukTV/header-page.png",
            BannerSrc: "/images/projects/sandukTV/header-page.png",
            shortInfo: {
              ru: "Обзор раздела «Шапка сайта»",
              en: "Overview of the «Header» section",
              tj: "Баррасии бахши «Сарлавҳаи сомона»",
            ...
            fullInfo: {
              ru: "Раздел «Шапка сайта» платформы Sanduk TV разработан с учетом современных требований к дизайну и удобству использования, предоставляя посетителям всю необходимую информацию о цифровом ТВ.",
              en: "The «Header» section of the Sanduk TV platform is designed with modern UI/UX requirements in mind, providing visitors with all necessary information about digital TV.",
              tj: "Бахши «Сарлавҳаи сомона»-и платформаи Sanduk TV бо назардошти талаботи муосир ба тарроҳӣ ва қулайии истифода таҳия шудааст ва ба меҳмонон тамоми маълумоти заруриро дар бораи телевизиони рақамӣ пешниҳод мекунад.",
            },
          },
          {
            ...
            imageSrc: "/images/projects/sandukTV/advantages-page.png",
            BannerSrc: "/images/projects/sandukTV/advantages-page.png",
            shortInfo: {
              ru: "Обзор раздела «Преимущества»",
              en: "Overview of the «Advantages» section",
              tj: "Баррасии бахши «Афзалиятҳо»",
            },
            fullInfo: {
              ru: "Раздел «Преимущества» платформы Sanduk TV разработан с учетом современных требований к дизайну и удобству использования, предоставляя посетителям всю необходимую информацию о цифровом ТВ.",
              en: "The «Advantages» section of the Sanduk TV platform is designed with modern UI/UX requirements in mind, providing visitors with all necessary information about digital TV.",
              tj: "Бахши «Афзалиятҳо»-и платформаи Sanduk TV бо назардошти талаботи муосир ба тарроҳӣ ва қулайии истифода таҳия шудааст ва ба меҳмонон тамоми маълумоти заруриро дар бораи телевизиони рақамӣ пешниҳод мекунад.",
            },
          },
          {
            slug: "dealers-page",
            ...
            imageSrc: "/images/projects/sandukTV/dealers-page.png",
            BannerSrc: "/images/projects/sandukTV/dealers-page.png",
            shortInfo: {
              ru: "Обзор раздела «Дилерам»",
              en: "Overview of the «Dealers» section",
              tj: "Баррасии бахши «Дилерҳо»",
            },
            fullInfo: {
              ru: "Раздел «Дилерам» платформы Sanduk TV разработан с учетом современных требований к дизайну и удобству использования, предоставляя посетителям всю необходимую информацию о цифровом ТВ.",
              en: "The «Dealers» section of the Sanduk TV platform is designed with modern UI/UX requirements in mind, providing visitors with all necessary information about digital TV.",
              tj: "Бахши «Дилерҳо»-и платформаи Sanduk TV бо назардошти талаботи муосир ба тарроҳӣ ва қулайии истифода таҳия шудааст ва ба меҳмонон тамоми маълумоти заруриро дар бораи телевизиони рақамӣ пешниҳод мекунад.",
            },
          },
          {
            slug: "decide-on-the-package-page",
            title: {
              ru: "Выбор пакета",
              en: "Choose Package",
              tj: "Интихоби баста",
            ...
            shortInfo: {
              ...
              tj: "Баррасии бахши «Интихоби баста»",
            },
            fullInfo: {
              ru: "Раздел «Выбор пакета» платформы Sanduk TV разработан с учетом современных требований к дизайну и удобству использования, предоставляя посетителям всю необходимую информацию о цифровом ТВ.",
              en: "The «Choose Package» section of the Sanduk TV platform is designed with modern UI/UX requirements in mind, providing visitors with all necessary information about digital TV.",
              tj: "Бахши «Интихоби баста»-и платформаи Sanduk TV бо назардошти талаботи муосир ба тарроҳӣ ва қулайии истифода таҳия шудааст ва ба меҳмонон тамоми маълумоти заруриро дар бораи телевизиони рақамӣ пешниҳод мекунад.",
            },
          },
          {
            slug: "frequently-asked-questions-page",
            title: {
              ru: "Частые вопросы",
              en: "FAQ",
            ...
            shortInfo: {
              ...
              tj: "Баррасии бахши «Саволҳои зиёд додашаванда»",
            },
            fullInfo: {
              ru: "Раздел «Частые вопросы» платформы Sanduk TV разработан с учетом современных требований к дизайну и удобству использования, предоставляя посетителям всю необходимую информацию о цифровом ТВ.",
              en: "The «FAQ» section of the Sanduk TV platform is designed with modern UI/UX requirements in mind, providing visitors with all necessary information about digital TV.",
              tj: "Бахши «Саволҳои зиёд додашаванда»-и платформаи Sanduk TV бо назардошти талаботи муосир ба тарроҳӣ ва қулайии истифода таҳия шудааст ва ба меҳмонон тамоми маълумоти заруриро дар бораи телевизиони рақамӣ пешниҳод мекунад.",
            },
          },
          {
            slug: "how-to-connect-page",
            title: {
              ru: "Как подключиться",
              en: "How to Connect",
              tj: "Чӣ тавр пайваст шудан",
            },
            imageSrc: "/images/projects/sandukTV/how-to-connect-page.png",
            BannerSrc: "/images/projects/sandukTV/how-to-connect-page.png",
            shortInfo: {
              ru: "Обзор раздела «Как подключиться»",
              en: "Overview of the «How to Connect» section",
              tj: "Баррасии бахши «Чӣ тавр пайваст шудан»",
            },
            fullInfo: {
              ru: "Раздел «Как подключиться» платформы Sanduk TV разработан с учетом современных требований к дизайну и удобству использования, предоставляя посетителям всю необходимую информацию о цифровом ТВ.",
              en: "The «How to Connect» section of the Sanduk TV platform is designed with modern UI/UX requirements in mind, providing visitors with all necessary information about digital TV.",
              tj: "Бахши «Чӣ тавр пайваст шудан»-и платформаи Sanduk TV бо назардошти талаботи муосир ба тарроҳӣ ва қулайии истифода таҳия шудааст ва ба меҳмонон тамоми маълумоти заруриро дар бораи телевизиони рақамӣ пешниҳод мекунад.",
            },
          },
          {
            slug: "subscription-package-page",
            title: {
              ru: "Пакеты подписки",
              en: "Subscription Packages",
              tj: "Бастаҳои обуна",
            },
            ...
            shortInfo: {
              ...
              tj: "Баррасии бахши «Бастаҳои обуна»",
            },
            fullInfo: {
              ru: "Раздел «Пакеты подписки» платформы Sanduk TV разработан с учетом современных требований к дизайну и удобству использования, предоставляя посетителям всю необходимую информацию о цифровом ТВ.",
              en: "The «Subscription Packages» section of the Sanduk TV platform is designed with modern UI/UX requirements in mind, providing visitors with all necessary information about digital TV.",
              tj: "Бахши «Бастаҳои обуна»-и платформаи Sanduk TV бо назардошти талаботи муосир ба тарроҳӣ ва қулайии истифода таҳия шудааст ва ба меҳмонон тамоми маълумоти заруриро дар бораи телевизиони рақамӣ пешниҳод мекунад.",
            },
          },
          {
            slug: "footer-contacts-page",
            title: {
              ru: "Контакты и подвал",
              en: "Contacts and Footer",
              tj: "Тамосҳо ва поёни сомона",
            },
            imageSrc: "/images/projects/sandukTV/footer-contacts-page.png",
            BannerSrc: "/images/projects/sandukTV/footer-contacts-page.png",
            shortInfo: {
              ru: "Обзор раздела «Контакты и подвал»",
              en: "Overview of the «Contacts and Footer» section",
              tj: "Баррасии бахши «Тамосҳо ва поёни сомона»",
            },
            fullInfo: {
              ru: "Раздел «Контакты и подвал» платформы Sanduk TV разработан с учетом современных требований к дизайну и удобству использования, предоставляя посетителям всю необходимую информацию о цифровом ТВ.",
              en: "The «Contacts and Footer» section of the Sanduk TV platform is designed with modern UI/UX requirements in mind, providing visitors with all necessary information about digital TV.",
              tj: "Бахши «Тамосҳо ва поёни сомона»-и платформаи Sanduk TV бо назардошти талаботи муосир ба тарроҳӣ ва қулайии истифода таҳия шудааст ва ба меҳмонон тамоми маълумоти заруриро дар бораи телевизиони рақамӣ пешниҳод мекунад.",
            },
          },
        ],
      },
        ...
        items: [
          {
            ...
            imageSrc: "/images/projects/onlinepay/header-page.png",
            BannerSrc: "/images/projects/onlinepay/header-page.png",
            shortInfo: {
              ru: "Обзор раздела «Шапка сайта»",
              en: "Overview of the «Header» section",
              tj: "Баррасии бахши «Сарлавҳаи сомона»",
            ...
            fullInfo: {
              ru: "Раздел «Шапка сайта» платежной системы OnlinePay обеспечивает надежный, интуитивно понятный и безопасный интерфейс для пользователей и партнеров.",
              en: "The «Header» section of the OnlinePay payment system provides a reliable, intuitive, and secure interface for users and partners.",
              tj: "Бахши «Сарлавҳаи сомона»-и системаи пардохтии OnlinePay интерфейси боэътимод, фаҳмо ва бехатарро барои корбарон ва шарикон таъмин мекунад.",
            },
          },
          {
            slug: "about-the-service-page",
            title: {
              ru: "О сервисе",
              en: "About the Service",
              tj: "Дар бораи хизматрасонӣ",
            },
            imageSrc: "/images/projects/onlinepay/about-the-service-page.png",
            BannerSrc: "/images/projects/onlinepay/about-the-service-page.png",
            shortInfo: {
              ru: "Обзор раздела «О сервисе»",
              en: "Overview of the «About the Service» section",
              tj: "Баррасии бахши «Дар бораи хизматрасонӣ»",
            },
            fullInfo: {
              ru: "Раздел «О сервисе» платежной системы OnlinePay обеспечивает надежный, интуитивно понятный и безопасный интерфейс для пользователей и партнеров.",
              en: "The «About the Service» section of the OnlinePay payment system provides a reliable, intuitive, and secure interface for users and partners.",
              tj: "Бахши «Дар бораи хизматрасонӣ»-и системаи пардохтии OnlinePay интерфейси боэътимод, фаҳмо ва бехатарро барои корбарон ва шарикон таъмин мекунад.",
            },
          },
          {
            slug: "about-the-service-stage-page",
            title: {
              ru: "Этапы работы",
              en: "Service Stages",
              tj: "Марҳилаҳои кор",
            ...
            shortInfo: {
              ...
              tj: "Баррасии бахши «Марҳилаҳои кор»",
            },
            fullInfo: {
              ru: "Раздел «Этапы работы» платежной системы OnlinePay обеспечивает надежный, интуитивно понятный и безопасный интерфейс для пользователей и партнеров.",
              en: "The «Service Stages» section of the OnlinePay payment system provides a reliable, intuitive, and secure interface for users and partners.",
              tj: "Бахши «Марҳилаҳои кор»-и системаи пардохтии OnlinePay интерфейси боэътимод, фаҳмо ва бехатарро барои корбарон ва шарикон таъмин мекунад.",
            },
          },
          {
            slug: "beginning-documentation-page",
            title: {
              ru: "Начало документации",
            ...
            shortInfo: {
              ...
              tj: "Баррасии бахши «Оғози ҳуҷҷатгузорӣ»",
            },
            fullInfo: {
              ru: "Раздел «Начало документации» платежной системы OnlinePay обеспечивает надежный, интуитивно понятный и безопасный интерфейс для пользователей и партнеров.",
              en: "The «Documentation Start» section of the OnlinePay payment system provides a reliable, intuitive, and secure interface for users and partners.",
              tj: "Бахши «Оғози ҳуҷҷатгузорӣ»-и системаи пардохтии OnlinePay интерфейси боэътимод, фаҳмо ва бехатарро барои корбарон ва шарикон таъмин мекунад.",
            },
          },
          {
            slug: "last-documentation-page",
            title: {
              ru: "Продолжение документации",
              en: "Documentation Details",
              tj: "Тафсилоти ҳуҷҷатгузорӣ",
            },
            imageSrc: "/images/projects/onlinepay/last-documentation-page.png",
            BannerSrc: "/images/projects/onlinepay/last-documentation-page.png",
            shortInfo: {
              ru: "Обзор раздела «Продолжение документации»",
              en: "Overview of the «Documentation Details» section",
              tj: "Баррасии бахши «Тафсилоти ҳуҷҷатгузорӣ»",
            },
            fullInfo: {
              ru: "Раздел «Продолжение документации» платежной системы OnlinePay обеспечивает надежный, интуитивно понятный и безопасный интерфейс для пользователей и партнеров.",
              en: "The «Documentation Details» section of the OnlinePay payment system provides a reliable, intuitive, and secure interface for users and partners.",
              tj: "Бахши «Тафсилоти ҳуҷҷатгузорӣ»-и системаи пардохтии OnlinePay интерфейси боэътимод, фаҳмо ва бехатарро барои корбарон ва шарикон таъмин мекунад.",
            },
          },
          {
            slug: "login-page",
            ...
            imageSrc: "/images/projects/onlinepay/login-page.png",
            BannerSrc: "/images/projects/onlinepay/login-page.png",
            shortInfo: {
              ru: "Обзор раздела «Авторизация»",
              en: "Overview of the «Login» section",
              tj: "Баррасии бахши «Воридшавӣ»",
            ...
            fullInfo: {
              ru: "Раздел «Авторизация» платежной системы OnlinePay обеспечивает надежный, интуитивно понятный и безопасный интерфейс для пользователей и партнеров.",
              en: "The «Login» section of the OnlinePay payment system provides a reliable, intuitive, and secure interface for users and partners.",
              tj: "Бахши «Воридшавӣ»-и системаи пардохтии OnlinePay интерфейси боэътимод, фаҳмо ва бехатарро барои корбарон ва шарикон таъмин мекунад.",
            },
          },
          {
            slug: "opportunities-page",
            title: {
              ru: "Возможности",
              en: "Opportunities",
              tj: "Имкониятҳо",
            },
            imageSrc: "/images/projects/onlinepay/opportunities-page.png",
            BannerSrc: "/images/projects/onlinepay/opportunities-page.png",
            shortInfo: {
              ru: "Обзор раздела «Возможности»",
              en: "Overview of the «Opportunities» section",
              tj: "Баррасии бахши «Имкониятҳо»",
            },
            fullInfo: {
              ru: "Раздел «Возможности» платежной системы OnlinePay обеспечивает надежный, интуитивно понятный и безопасный интерфейс для пользователей и партнеров.",
              en: "The «Opportunities» section of the OnlinePay payment system provides a reliable, intuitive, and secure interface for users and partners.",
              tj: "Бахши «Имкониятҳо»-и системаи пардохтии OnlinePay интерфейси боэътимод, фаҳмо ва бехатарро барои корбарон ва шарикон таъмин мекунад.",
            },
          },
          {
            slug: "to-receive-an-offer-page",
            title: {
            ...
            shortInfo: {
              ...
              tj: "Баррасии бахши «Гирифтани пешниҳод»",
            },
            fullInfo: {
              ru: "Раздел «Получить предложение» платежной системы OnlinePay обеспечивает надежный, интуитивно понятный и безопасный интерфейс для пользователей и партнеров.",
              en: "The «Get an Offer» section of the OnlinePay payment system provides a reliable, intuitive, and secure interface for users and partners.",
              tj: "Бахши «Гирифтани пешниҳод»-и системаи пардохтии OnlinePay интерфейси боэътимод, фаҳмо ва бехатарро барои корбарон ва шарикон таъмин мекунад.",
            },
          },
          {
            slug: "footer-contacts-page",
            ...
            imageSrc: "/images/projects/onlinepay/footer-contacts-page.png",
            BannerSrc: "/images/projects/onlinepay/footer-contacts-page.png",
            shortInfo: {
              ru: "Обзор раздела «Контакты и подвал»",
              en: "Overview of the «Contacts and Footer» section",
              tj: "Баррасии бахши «Тамосҳо ва поёни сомона»",
            ...
            fullInfo: {
              ru: "Раздел «Контакты и подвал» платежной системы OnlinePay обеспечивает надежный, интуитивно понятный и безопасный интерфейс для пользователей и партнеров.",
              en: "The «Contacts and Footer» section of the OnlinePay payment system provides a reliable, intuitive, and secure interface for users and partners.",
              tj: "Бахши «Тамосҳо ва поёни сомона»-и системаи пардохтии OnlinePay интерфейси боэътимод, фаҳмо ва бехатарро барои корбарон ва шарикон таъмин мекунад.",
            },
          },
        ],
      },
