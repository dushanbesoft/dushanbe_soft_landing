...
Стратегия доступности платформы выстроена вокруг принципа бесшовного пользовательского опыта (*seamless experience*). Современный зритель не привязан к одной точке: он начинает просмотр утреннего выпуска новостей на смартфоне в дороге, продолжает знакомство с познавательной программой на рабочем компьютере через веб-интерфейс, а вечерний фильм или сериал включает на большом экране гостиной.
 ...
 iOS и iPadOS:  Нативная оптимизация под устройства Apple гарантирует высокую энергоэффективность, плавность интерфейса благодаря поддержке ProMotion, интеграцию с системным плеером и технологией AirPlay для мгновенной трансляции �           {
            slug: "web-recommendations-top",
            title: "Главные новинки",
            imageSrc: "/images/projects/mavjisomon/web-recommendations-top.png",
            BannerSrc: "/images/projects/mavjisomon/web-recommendations-top.png",
            shortInfo: "Премьеры и Эксклюзивы",
            fullInfo:
              "Блок «Главные новинки» (Hero Banner) — это самый крупный и заметный элемент на стартовой странице Mavji Somon. Он выполнен в формате эффектного слайдера, который привлекает внимание пользователя с первых секунд. Именно здесь анонсируются главные премьеры недели, эксклюзивные сериалы и самые ожидаемые фильмы платформы.\n\nОсновная задача этого компонента — максимальное вовлечение зрителя. Огромные широкоформатные постеры, плавная анимация переходов и выразительные кнопки действий (Call to Action) позволяют аудитории мгновенно перейти к просмотру топового контента. Система автоматически ротирует баннеры на основе актуальных релизов, гарантируя, что при каждом заходе на сайт пользователь будет видеть свежие предложения и не пропустит хиты сезона.",
          },�я платформ 
...
Минималистичный блок иконок на веб-сайте выполняет роль прямого навигационного моста: клик по соответствующему логотипу мгновенно перенаправляет пользователя в официальные магазины приложений (Google Play, App Store) или открывает инструкцию по быстрой установке клиента на телевизор с помощью QR-кода. Такой подход снижает порог входа, укрепляет доверие аудитории к технологической зрелости Mavji Somon и превращает сервис в универсальную медиасреду, готовую к работе на любом экране.`,
          ...
          //   imageSrc: "/images/projects/mavjisomon/web-top.png",
          //   BannerSrc: "/images/projects/mavjisomon/web-top1.png",
          ...
          // },
          {
            ...
            imageSrc: "/images/projects/mavjisomon/web-radio.png",
            BannerSrc: "/images/projects/mavjisomon/web-radio1.png",
          ...
          },
          {
            ...
            imageSrc: "/images/projects/mavjisomon/web-tv.png",
            BannerSrc: "/images/projects/mavjisomon/web-tv1.png",
