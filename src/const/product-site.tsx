export const ProductSite = [
  ...
  },
  {
    ...
    description:
      "Вебсайти расмии ширкати телекоммуникатсионӣ ва провайдери интернетии «Telecomm Technology». Платформа маълумотро дар бораи тарофаҳои интернети баландсуръат, телевизиони интерактивӣ (IPTV) ва телефонияи IP/NGN пешниҳод намуда, инчунин дастрасӣ ба кабинети шахсии муштариёнро таъмин менамояд.",
    tags: [
      "Node.js",
      "ASP.NET Core",
      "JavaScript",
  ...
  },
  {
    ...
    year: "2024",
    title: "OnlinePay – Низоми пардохт",
    description:
      "Платформаи интернет-эквайринги (Merchant Services), ки ба ширкатҳо ва тиҷорати онлайн имкон медиҳад пардохтҳоро барои молу хизматрасониҳо тавассути кортҳои миллии бонкии «Корти Миллӣ» қабул намоянд. Хизматрасонӣ қарорҳои оддӣ ва қулайи ҳамгироиро пешниҳод мекунад, новобаста аз соҳаи фаъолият, миқёси бизнес ва мавҷудияти мутахассисони техникӣ дар ширкат.",
    tags: [
  ...
  },
  {
    ...
    year: "2024",
    title: "Zenith Valuation",
    description:
      "Вебсайти корпоративии ширкати амрикоии арзёбӣ ва машваратии Zenith Valuation. Платформа маҷмӯи хизматрасониҳои касбӣ дар самти арзёбӣ ва таҳлили экспертизаро барои соҳаҳои гуногуни бизнес пешниҳод менамояд. Лоиҳа ба пешниҳоди қарорҳои мустақил, аз ҷиҳати техникӣ асоснок ва мутобиқ ба стандартҳои баланди сифат ва хизматрасонии муштариён равона шудааст.",
    tags: [
      "PHP (Laravel Framework)",
      "JavaScript",
      "MS SQL",
  ...
  },
  {
    ...
    year: "2024",
    title: "ООО «IMRON NAKLIET»",
    description:
      "Вебсайти корпоративии ширкати байналмилалии логистикии ҶДММ «IMRON NAKLIET». Платформа барои муаррифии маҷмӯи пурраи хизматрасониҳои нақлиётӣ ва логистикӣ таҳия шудааст, ки интиқоли байналмилалии борҳои ҷамъшуда ва калонҳаҷм, логистикаи ҳароратӣ, хатсайрҳои мултимодалӣ (аз дар то дар) ва барасмиятдарории гумрукиро дар бар мегирад.",
    tags: [
      "PHP (Laravel Framework)",
      "JavaScript",
      "MS SQL",
