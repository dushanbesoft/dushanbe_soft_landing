      ...
      <div className={styles.container}>
        <div className={styles.leftCol}>
          <div className={styles.textContent}>
            <span className={styles.subtitle}>Связаться с нами</span>
            <h2 className={styles.title}>
              <span className={styles.titleBlack}>Давайте обсудим</span><br />
              <div className={styles.titleInline}>
                <span className={styles.titleBlack}>ваш&nbsp;</span>
                <span className={styles.titleGradient}>проект.</span>
              </div>
            </h2>
          ...
          <div className={styles.features}>
            <div className={styles.featureItem}>
              ...
              <div className={styles.featureTexts}>
                <span className={styles.featureLabel}>Ответ в течение</span>
                <span className={styles.featureValue}>2 часов</span>
              </div>
            </div>
            ...
            <div className={styles.featureItem}>
              ...
              <div className={styles.featureTexts}>
                <span className={styles.featureLabel}>Конфиденциальность</span>
                <span className={styles.featureValue}>гарантирована</span>
              </div>
            </div>
            ...
            <div className={styles.featureItem}>
              ...
              <div className={styles.featureTexts}>
                <span className={styles.featureLabel}>Бесплатная</span>
                <span className={styles.featureValue}>консультация</span>
              </div>
            </div>
          </div>
          ...
          <div className={styles.teamBox}>
            ...
            <p className={styles.teamText}>
              Наша команда экспертов готова помочь вам в реализации проекта
            </p>
          </div>

          <div className={styles.messengersSection}>
            <p className={styles.messengersTitle}>Или пишите нам в удобный мессенджер</p>
          ...
          <div className={styles.formCard}>
            <div className={styles.formHeader}>
              ...
              <div className={styles.formHeaderTexts}>
                ...
                <p className={styles.formSubtitle}>Мы свяжемся с вами для обсуждения деталей</p>
              </div>
            </div>
            ...
            <form className={styles.form}>
              <div className={styles.formRow}>
                ...
                <div className={styles.formGroup}>
                  ...
                  <input type="email" className={styles.input} placeholder="email@company.com" />
                </div>
              </div>
              ...
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  <input type="tel" className={styles.input} placeholder="+992 _ _ _ _ _ _ _ _ _" />
                </div>
                <div className={styles.formGroup}>
              ...
              <div className={styles.formGroup}>
                ...
                <textarea className={styles.textarea} placeholder="Расскажите о вашем проекте: задача, масштаб, сроки…"></textarea>
              </div>
