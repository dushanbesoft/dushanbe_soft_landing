            ...
            <div className={styles.avatarsGroup}>
              ...
              <div className={styles.avatarPlus} style={{ zIndex: 6, marginLeft: '-15px' }}>
                <svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <rect x="0.5" y="0.5" width="63" height="63" rx="31.5" stroke="#5EB5F0" strokeOpacity="0.41"/>
            ...
            <form className={styles.form}>
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  <label className={styles.label}>{t('contact.form.nameLabel', 'Имя')}</label>
                  <input type="text" className={styles.input} placeholder={t('contact.form.namePlaceholder', 'Ваше имя')} />
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.label}>{t('contact.form.emailLabel', 'Email')}</label>
                  <input type="email" className={styles.input} placeholder={t('contact.form.emailPlaceholder', 'email@company.com')} />
                </div>
              </div>

              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  <label className={styles.label}>{t('contact.form.phoneLabel', 'Телефон')}</label>
                  <input type="tel" className={styles.input} placeholder={t('contact.form.phonePlaceholder', '+992 _ _ _ _ _ _ _ _ _')} />
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.label}>{t('contact.form.directionLabel', 'Направление')}</label>
                  <div className={styles.selectWrapper}>
                    <select className={styles.select}>
                      <option>{t('contact.form.directionOptions.opt1', 'Выберите услугу')}</option>
                      <option>{t('contact.form.directionOptions.opt2', 'Разработка ПО')}</option>
                      <option>{t('contact.form.directionOptions.opt3', 'Веб-разработка')}</option>
                      <option>{t('contact.form.directionOptions.opt4', 'Аутсорсинг IT')}</option>
                    </select>
                    <svg className={styles.selectArrow} width="9" height="5" viewBox="0 0 9 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M8.93514 0.41361L4.73921 4.903C4.71102 4.93323 4.67504 4.95766 4.63401 4.97447C4.59297 4.99127 4.54794 5 4.50232 5C4.45669 5 4.41166 4.99127 4.37063 4.97447C4.32959 4.95766 4.29362 4.93323 4.26542 4.903L0.0660816 0.41361C-0.0907119 0.247017 0.0490387 1.31863e-08 0.301272 1.31863e-08L8.69654 1.31863e-08C8.75347 -1.53927e-05 8.80926 0.0134689 8.85752 0.0389111C8.90579 0.0643533 8.94458 0.100727 8.96947 0.143873C8.99436 0.187019 9.00434 0.235195 8.99827 0.282895C8.9922 0.330595 8.97032 0.375893 8.93514 0.41361Z" fill="black"/>
                    </svg>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.formGroup}>
                <label className={styles.label}>{t('contact.form.messageLabel', 'Сообщение')}</label>
                <textarea className={styles.textarea} placeholder={t('contact.form.messagePlaceholder', 'Расскажите о вашем проекте: задача, масштаб, сроки…')}></textarea>
              </div>

              <button type="button" className={styles.submitBtn}>
                <span>{t('contact.form.submitBtn', 'Отправить заявку')}</span>
